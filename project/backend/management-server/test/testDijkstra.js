    ...
    describe("POST /", function () {
        ...
        it("Zou het pad moeten zoeken", function (done) {
            chai.request(app)
                ...
                .set('Content-Type', 'application/json')
                .send({
                    "mapId": "5c86b0b3c61ba3362c369eba",
                    "waypoints": [
                        {
                            "x": 1,
                            "y": 1
