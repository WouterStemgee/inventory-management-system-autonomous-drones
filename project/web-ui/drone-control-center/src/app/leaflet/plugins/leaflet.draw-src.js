...
L.drawLocal = {
	...
	draw: {
		toolbar: {
			...
			undo: {
				title: 'Delete last waypoint drawn',
				text: 'Delete last waypoint'
			},
			buttons: {
				polyline: 'Draw a flightpath',
				polygon: 'Draw a flightpath',
				rectangle: 'Draw a obstacle',
				circle: 'Draw a scanzone',
		...
		handlers: {
			circle: {
				tooltip: {
					start: 'Click and drag to draw scanzone.'
				},
				radius: 'Range'
			},
			circlemarker: {
			...
			polyline: {
				...
				tooltip: {
					start: 'Click to start drawing flightpath.',
					cont: 'Click to continue drawing flightpath.',
					end: 'Click last point to finish flightpath.'
				}
			},
			rectangle: {
				tooltip: {
					start: 'Click and drag to draw obstacle.'
				}
			},
			simpleshape: {
				tooltip: {
		...
		readableDistance: function (distance, isMetric, isFeet, isNauticalMile, precision) {
			...
			switch (units) {
				case 'metric':
					...
					if (distance > 1000) {
						distanceStr = L.GeometryUtil.formattedNumber(distance / 1000, precision['km']) + ' m';
					} else {
						distanceStr = L.GeometryUtil.formattedNumber(distance, precision['m']) + ' mm';
					}
					break;
				case 'feet':
					distance *= 1.09361 * 3;
